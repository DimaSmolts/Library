...
export default class PurchaseCompletion extends React.Component<PurchaseCompletionProps> {
  render() {
    return <div className='purchase-completion'>
      ...
      {
        this.props.bookCartRecords.map((br, index) => {
          return <>
      ...
      <button
        ...
        onClick={this.props.handlePurchaseCompletion}>
        Submit</button>
    </div>
  }
}
